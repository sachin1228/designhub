  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden animate-pulse">
      ...
      <div className="px-5 pt-4 border-b border-border shrink-0">
        ...
        {/* Row 2: tabs — Chat / Threads / Events / Members */}
      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col justify-end gap-3">
            ...
            {/* Other — consecutive (no avatar) */}
            <div className="flex items-start gap-2.5">
              <div className="w-7 shrink-0" />
              <div className="h-10 w-72 rounded-2xl rounded-tl-sm bg-surface-raised max-w-[65%]" />
            </div>
