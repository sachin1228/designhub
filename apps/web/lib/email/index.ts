        ...
        <tr>
          <td style="padding:32px 40px 0;background:#1B1918;">
            <p style="margin:0;font-size:20px;font-weight:600;color:#F5F2F0;">
              ${APP_NAME}<span style="color:#0057b7;">/</span>
            </p>
          </td>
        </tr>
        <tr>
          <td style="padding:32px 40px;">
            ...
            <a href="${link}"
               style="display:inline-block;padding:12px 28px;background:#0057b7;color:#fff;font-size:15px;font-weight:500;border-radius:8px;text-decoration:none;">
              Reset password
            </a>
